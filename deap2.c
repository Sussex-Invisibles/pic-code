...
long N, num, numhi, numlo, width, height, pheight, dtoabit, pperiod, measuredph, extavedph, count;
...
output_B(0b00000100); //select D/A
output_low(PIN_D6);  //Set clock low
for(i=1;i<=14;i++)
{
 dtoabit=bit_test(height,13); //look at Bit13
 output_bit(PIN_D5, dtoabit);   //present data to AD5551
 output_high(PIN_D6);   //clock data
 output_low(PIN_D6);
...
char romcode[120]={0x28,0x6C,0x79,0x62,0x04,0x00,0x00,0x37,0x28,0x20,0xAF,0x62,0x04,0x00,0x00,0xFD,
0x28,0xBC,0xA9,0x62,0x04,0x00,0x00,0xAD,0x28,0x95,0xD2,0x62,0x04,0x00,0x00,0x90,
0x28,0xCA,0xEB,0x62,0x04,0x00,0x00,0xED,0x28,0x20,0x35,0x62,0x04,0x00,0x00,0xF7,
0x28,0xD4,0xE5,0x61,0x04,0x00,0x00,0x8F,0x28,0x06,0xB3,0x62,0x04,0x00,0x00,0xA4,
0x28,0x2C,0xC1,0x62,0x04,0x00,0x00,0x33,0x28,0x8B,0xB4,0x62,0x04,0x00,0x00,0x55,
0x28,0xAE,0x36,0x62,0x04,0x00,0x00,0x40,0x28,0x75,0xBB,0x62,0x04,0x00,0x00,0x5B,
0x28,0x21,0x7C,0x62,0x04,0x00,0x00,0xDA,0x28,0x15,0x93,0x62,0x04,0x00,0x00,0x5E,
0x28,0xB1,0xF1,0x62,0x04,0x00,0x00,0x4C};
